  ...
  return (
    <div className="bg-navy p-4 md:p-8 rounded-lg ml-3.5 mt-1 w-full md:w-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-navy hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded flex items-center justify-center w-full sm:w-auto mb-4 md:mb-0 md:w-1/5 p-3 border border-white" onClick={() => {console.log("filter order")}}>
            ...
            {[...Array(20)].map((_, index) => (
              <tr className="text-gray-200" key={index}>
                ...
                <td className="px-2 md:px-4 py-3">
                  <span className="px-2 md:px-4 py-1 rounded-full bg-lightRed font-semibold text-pink text-xs md:text-sm">
                    Completed
                  </span>
                </td>
              </tr>
