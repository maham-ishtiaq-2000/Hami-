...
import Products from '../components/ProduceManagementComponent/Products';
  ...
  return (
    ...
    <div className="flex flex-col h-screen bg-lightNavy">
      ...
      <div className="flex-1 p-10" style={{ marginLeft: "100px"  }}>
          <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-white mb-4">Products Management</h1>
          <div className="w-full rounded-tl rounded-tr bg-navy" style={{ height: "80vh", marginTop: "10px", padding: "12px", overflow: "auto" }}>
            ...
            <TabNavigation context="productManagement"></TabNavigation>
          </div>
